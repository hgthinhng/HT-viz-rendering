"""
Opvia Wave 9 - Editorial Signatures
=====================================

Editorial flourishes làm output Opvia khác biệt với output AI generic.
Đây không phải data viz - đây là typographic furniture.

Components:
1. marginalia        - Chú thích lề brass italic, có thể có pull-out arrow
2. chart_dropcap     - Drop cap chữ đầu đoạn cạnh chart, body wraps around
3. path_progression  - Đường brass mảnh chạy ngang qua section với milestones
...
def marginalia(
    ...
    """
    Wrap body trong layout 2 cột với chú thích lề brass italic.
...
def path_progression(
    ...
    """
    Đường brass mảnh chạy ngang qua section với 3-7 milestones.
    ...
    milestones: [{
        ...
        "highlight": True,           # optional - dot brass to hơn
    ...
    for i, m in enumerate(milestones):
        ...
        # Dot styling
        if marker == "current":
            r, fill, stroke = 6, COLORS.BRASS, COLORS.BRASS_700
        elif marker == "completed":
            r, fill, stroke = 5, COLORS.PRUSSIAN, COLORS.PRUSSIAN
        elif marker == "future":
            r, fill, stroke = 5, COLORS.PAPER, COLORS.BRASS
        else:
            r = 5.5 if is_hl else 4.0
            fill = COLORS.BRASS if is_hl else COLORS.SLATE
            stroke = fill
        ...
        if show_arrows and i < n - 1:
            ...
            items_html.append(
                ...
                f'font-family="{FONTS.SANS}" font-size="9" fill="{COLORS.BRASS}" opacity="0.7">▸</text>'
            )
...
<div class="vw-path-progression">
  ...
  <svg viewBox="0 0 {W} {H}" xmlns="http://www.w3.org/2000/svg" class="vw-path-svg">
    <path d="{main_path}" fill="none" stroke="{COLORS.BRASS}"
