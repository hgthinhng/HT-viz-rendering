...
**Output:** Full-page HTML+CSS, render qua stocklpt-DeepAnalysis-polish
...
- Page 1 của PDF, full-bleed Indigo-900 background.
...
- Daily report - dùng header gọn của stocklpt-DailyReport-polish thay.
...
│                                           │
│  Ai hưởng lợi, ai chịu thiệt?             │  <- SUBTITLE: PFD italic accent ~22pt
│                                           │
...
│          Mức cao kỷ lục, vượt xa trần       │     JetBrains Mono accent ~96pt
│          quy chế 85% - tín hiệu hệ thống    │     + label uppercase accent
│          đang căng.                         │     + description ivory
│                                           │
│  TRONG BÀI NÀY                            │  <- eyebrow accent uppercase
...
│  STOCKLPT ACADEMY  14 PHÚT     25/04/2026    │     uppercase accent labels
│                                           │     + ivory values
└───────────────────────────────────────────┘
```
...
cover_meta = {
    ...
    "subtitle": "Ai hưởng lợi, ai chịu thiệt?",  # PFD italic accent
...
<section class="cover-deep">
  <div class="cover-masthead">
    ...
    <div class="cover-brand">STOCKLPT ACADEMY</div>
  </div>
...
- Background: Indigo-900 `#130B24`
- Accent dashes: `#16633C`, font-size 14pt, letter-spacing 0.4em
- Brand "STOCKLPT ACADEMY": Inter 700, ivory `#EBEFF4`, letter-spacing 0.25em, ~14pt
- Eyebrow: Inter 600, accent, uppercase, letter-spacing 0.18em, ~10pt
- Title: PFD italic, ivory, ~52pt, line-height 1.05
- Subtitle: PFD italic, accent, ~22pt
- Dek: Inter regular, ivory, ~14pt, line-height 1.6
- Hero number: JetBrains Mono, accent, ~96pt, font-weight 500
- Hero label: Inter 600, accent, uppercase, ~10pt
- Hero desc: Inter regular, ivory `#EBEFF4 95%`, ~12pt
- Takeaways arrow ▸: accent
- Footer label: Inter 600, accent, uppercase, ~10pt, letter-spacing 0.18em
- Footer value: Inter regular, ivory, ~12pt
- Cover rule: 1px accent, width ~25% page
...
- 3 accent dashes trên cùng (`··· ··· ···`) là signature visual của StockLPT - giữ nguyên trong tất cả cover deep.
