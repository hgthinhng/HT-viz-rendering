...
- `compass_callout` - wrap gauge bằng editorial caption sidebar accent rule.
...
Output: fill indigo (chưa breach), nhưng visual proximity tới threshold đã đủ tension.
...
- Color hardcoded: indigo normal, bordeaux danger, accent tick threshold.
