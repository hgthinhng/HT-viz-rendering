"""
StockLPT Deep Analysis - 9 Cover Variants
...
.cover-quick-take h1 {
  ...
  color: #2A1A4A; margin-bottom: 6mm;
  max-width: 150mm;
}
.cover-quick-take .qt-dek {
  font-family: 'PFD', 'PFDVN', serif;
  font-weight: 450; font-size: 12pt;
  line-height: 1.55; color: #514B78;
...
.cover-quick-take .qt-takeaway-label {
  ...
  letter-spacing: 0.18em; color: #16633C;
  margin-bottom: 3mm;
}
...
.cover-quick-take .qt-footer {
  ...
  padding-top: 6mm;
  border-top: 0.5px solid rgba(81,75,120,0.2);
}
...
.cover-quick-take .qt-footer-label {
  ...
  letter-spacing: 0.16em; color: #16633C;
...
.cover-sector-brief .sb-eyebrow {
  ...
  font-size: 8pt; font-weight: 700;
  letter-spacing: 0.2em; text-transform: uppercase;
  color: #16633C; margin-bottom: 5mm;
}
...
.cover-sector-brief .sb-entity-direction.up { color: #21B36A; }
.cover-sector-brief .sb-entity-direction.down { color: #E13453; }
.cover-sector-brief .sb-entity-direction.neutral { color: #645B76; }

/* ---------- COVER 4: POLICY WATCH ---------- */
.cover-policy-watch {
  background: #130B24; color: #F4F6F9;
}
.cover-policy-watch .pw-header {
  display: flex; justify-content: space-between;
  align-items: baseline;
  padding-bottom: 4mm;
  border-bottom: 1px solid rgba(22,99,60,0.4);
  margin-bottom: 14mm;
}
...
.cover-policy-watch .pw-meta {
  font-family: 'JBM', 'JBMVN', monospace;
  font-size: 8pt; color: rgba(244,246,249,0.6);
}
...
.cover-policy-watch h1 {
  ...
  line-height: 1.05;
  color: #F4F6F9; margin-bottom: 6mm;
  max-width: 145mm;
}
...
.cover-policy-watch .pw-timeline-title {
  font-family: 'Inter', 'InterVN', sans-serif;
  font-size: 8pt; font-weight: 700;
  letter-spacing: 0.2em; color: #16633C;
...
.cover-policy-watch .pw-event {
  padding: 4mm;
  background: rgba(81,75,120,0.18);
  border-top: 2px solid #16633C;
}
.cover-policy-watch .pw-event.current {
  border-top-color: #E13453;
  background: rgba(225,52,83,0.15);
}
...
.cover-policy-watch .pw-scenarios {
  ...
  gap: 5mm;
  padding-top: 6mm;
  border-top: 0.5px solid rgba(22,99,60,0.3);
}
...
.cover-policy-watch .pw-scenario-label {
  font-family: 'Inter', 'InterVN', sans-serif;
  font-size: 7pt; font-weight: 700;
  letter-spacing: 0.16em; color: rgba(244,246,249,0.7);
  margin-bottom: 1mm; text-transform: uppercase;
}
...
.cover-earnings .eb-metric-delta.up { color: #21B36A; }
.cover-earnings .eb-metric-delta.down { color: #E13453; }
.cover-earnings .eb-metric-delta.flat { color: #645B76; }
...
.cover-thematic .tm-header {
  display: flex; justify-content: space-between;
  padding-bottom: 4mm;
  border-bottom: 0.5px solid rgba(81,75,120,0.3);
  margin-bottom: 12mm;
}
...
.cover-thematic .tm-chart-caption {
  font-family: 'JBM', 'JBMVN', monospace;
  font-size: 7.5pt; color: rgba(244,246,249,0.7);
  margin-top: 3mm;
  display: flex; justify-content: space-between;
}
...
.cover-alert .al-banner {
  background: #E13453; color: #F4F6F9;
...
.cover-alert .al-eyebrow {
  ...
  font-size: 8pt; font-weight: 700;
  letter-spacing: 0.2em; text-transform: uppercase;
  color: #E13453; margin-bottom: 5mm;
}
.cover-alert h1 {
  font-family: 'PFD', 'PFDVN', serif;
  font-weight: 700; font-size: 32pt;
  line-height: 1.05; color: #2A1A4A;
  margin-bottom: 8mm; max-width: 145mm;
}
.cover-alert .al-stat {
  display: flex; align-items: baseline; gap: 6mm;
  padding: 6mm 0;
  border-top: 2px solid #E13453;
...
.cover-yearend h1 {
  font-family: 'PFD', 'PFDVN', serif;
  font-weight: 600; font-size: 22pt;
  line-height: 1.15; color: #F4F6F9;
  margin-bottom: 6mm; max-width: 140mm;
}
.cover-yearend .ye-dek {
  font-family: 'PFD', 'PFDVN', serif;
  font-weight: 500; font-size: 11pt;
  font-style: italic; color: rgba(244,246,249,0.82);
...
.cover-yearend .ye-stat-context {
  ...
  font-style: italic; color: rgba(244,246,249,0.7);
  line-height: 1.4;
}
...
.cover-pitch .pd-recommendation.buy { border-left-color: #21B36A; }
.cover-pitch .pd-recommendation.sell { border-left-color: #E13453; }
.cover-pitch .pd-recommendation.hold { border-left-color: #16633C; }
...
.cover-pitch .pd-recommendation.buy .pd-rec-action { color: #21B36A; }
.cover-pitch .pd-recommendation.sell .pd-rec-action { color: #E13453; }
.cover-pitch .pd-recommendation.hold .pd-rec-action { color: #16633C; }
.cover-pitch .pd-rec-target {
  font-family: 'JBM', 'JBMVN', monospace;
  font-size: 14pt; font-weight: 700;
  color: #2A1A4A; text-align: center;
  margin-top: 1mm;
}
.cover-pitch .pd-rec-upside {
  font-family: 'Inter', 'InterVN', sans-serif;
  font-size: 8pt; font-weight: 600;
  text-align: center; color: #645B76;
  margin-top: 1mm;
}
...
.cover-pitch .pd-bullet {
  ...
  font-size: 10pt;
  border-bottom: 0.4px solid rgba(81,75,120,0.15);
}
...
.cover-pitch .pd-footer-item .pd-footer-label {
  font-family: 'Inter', 'InterVN', sans-serif;
  font-size: 7pt; font-weight: 700;
  letter-spacing: 0.14em; color: #16633C;
...
def cover_thematic_macro(
    ...
    if not chart_data or len(chart_data) < 2:
        ...
        <svg class="tm-chart-svg" viewBox="0 0 {svg_w} {svg_h}" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="none">
          <path d="{area_d}" fill="#16633C" fill-opacity="0.18"/>
          <path d="{path_d}" fill="none" stroke="#16633C" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
        </svg>
        """
