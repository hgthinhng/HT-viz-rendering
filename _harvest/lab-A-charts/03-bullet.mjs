...
chart.setOption({
  ...baseOption({ title: 'Bullet: Thực tế vs kế hoạch theo KPI', subtitle: 'Đơn vị: tỷ đồng (riêng vòng quay HTK: lần)' }),
  tooltip: tooltipDefault,
  grid: { left: 170, right: 40, top: 60, bottom: 30 },
  xAxis: { type: 'value', max, axisLabel: TYPOGRAPHY.axisLabel, splitLine: { lineStyle: { color: PALETTE.gridline } } },
    ...
    },
    {
      ...
      renderItem: (params, api) => {
        ...
        return {
          ...
          style: { stroke: PALETTE.neutralDark, lineWidth: 3 },
        };
      },
...
fs.writeFileSync(new URL('./out-03-bullet.svg', import.meta.url), svg);
