...
const series = entities.map((e) => ({
  ...
  data: [e.t1, e.t2],
  symbolSize: 8,
  lineStyle: { width: e.highlight ? 3 : 1.5, color: e.highlight ? PALETTE.accent : PALETTE.neutralMid },
  itemStyle: { color: e.highlight ? PALETTE.accent : PALETTE.neutralMid },
  label: {
    show: true,
    formatter: (p) => `${e.label} ${fmtPercent(p.value, { decimals: 1 })}`,
    color: e.highlight ? PALETTE.textPrimary : PALETTE.textMuted,
...
chart.setOption({
  ...
  xAxis: { type: 'category', data: ['Q4/2025', 'Q4/2026'], boundaryGap: false, axisLine: { lineStyle: { color: PALETTE.axisLine } }, axisTick: { show: false }, axisLabel: TYPOGRAPHY.axisLabel, splitLine: { show: false } },
