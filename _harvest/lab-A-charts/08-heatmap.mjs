...
chart.setOption({
  ...
  visualMap: {
    ...
    inRange: { color: [PALETTE.negative, PALETTE.gridline, PALETTE.accent] }, // diverging: đỏ<->xám<->xanh, KHÔNG rainbow
  ...
  series: [
    {
      ...
      itemStyle: { borderColor: PALETTE.surface, borderWidth: 2 }, // surface gap giữa các ô
    },
  ],
});
