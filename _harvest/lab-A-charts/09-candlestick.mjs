...
chart.setOption({
  ...
  xAxis: [
    { type: 'category', data: dates, gridIndex: 0, axisLabel: { show: false }, axisLine: { lineStyle: { color: PALETTE.axisLine } }, axisTick: { show: false }, splitLine: { show: false } },
    { type: 'category', data: dates, gridIndex: 1, axisLabel: TYPOGRAPHY.axisLabel, axisLine: { lineStyle: { color: PALETTE.axisLine } }, axisTick: { show: false }, splitLine: { show: false } },
  ],
  yAxis: [
    { type: 'value', gridIndex: 0, scale: true, axisLabel: { ...TYPOGRAPHY.axisLabel, formatter: (v) => v.toFixed(1) }, splitLine: { lineStyle: { color: PALETTE.gridline } } }, // scale:true = KHÔNG ép về 0 (ngoại lệ có chủ đích cho OHLC)
