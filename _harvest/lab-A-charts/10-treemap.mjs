...
const groupColor = { 'Ngân hàng': PALETTE.accent, 'Bất động sản': PALETTE.neutralDark, 'Tiêu dùng': PALETTE.neutralMid, 'Năng lượng': PALETTE.accentDark };
const data = [
  ...
  series: [
    {
      ...
      itemStyle: { borderColor: PALETTE.surface, borderWidth: 2, gapWidth: 2 }, // surface gap giữa các ô, không dùng viền màu
      levels: [
