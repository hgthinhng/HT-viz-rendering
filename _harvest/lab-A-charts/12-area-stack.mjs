...
chart.setOption({
  ...baseOption({ title: 'Doanh thu theo mảng, cộng dồn', subtitle: 'Đơn vị: tỷ đồng — ≤4 dải để dải giữa vẫn đọc được' }),
  tooltip: { ...tooltipDefault, valueFormatter: (v) => fmtCompact(v, { baseUnit: 'ty', decimals: 0 }) },
  grid: { left: 60, right: 90, top: 60, bottom: 60 },
  xAxis: { type: 'category', data: periods, boundaryGap: false, axisLine: { lineStyle: { color: PALETTE.axisLine } }, axisTick: { show: false }, axisLabel: TYPOGRAPHY.axisLabel },
  yAxis: { type: 'value', min: 0, axisLabel: { ...TYPOGRAPHY.axisLabel, formatter: (v) => fmtCompact(v, { baseUnit: 'ty', decimals: 0 }) }, splitLine: { lineStyle: { color: PALETTE.gridline } } },
