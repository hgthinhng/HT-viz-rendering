...
Trong lúc render thật, phát hiện ba giới hạn của WeasyPrint 69.0 không liên quan gì đến nội
...
Ba phát hiện kỹ thuật" ở đầu `research/01-editorial/FINDINGS.md`.
